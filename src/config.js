...
export const DB_USER = process.env.DB_USER || 'CaiAmador';
export const DB_PASSWORD = process.env.DB_PASSWORD || 'ytz123456';
export const DB_DATABASE = process.env.DB_DATABASE || 'distribuidora_rs';
...
export const DB_DATABASE2 = process.env.DB_DATABASE || 'rs_distribuidora';
